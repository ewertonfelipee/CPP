...
int main(int argc, char *argv[])
{
    ...
    char *char_ptr;
    int mem_size;
    char *msg_error = "could not allocate heap memory.";
    // char msg_error[] = "could not allocate heap memory.";
    ...
    char_ptr = (char *)malloc_s(mem_size); // allocating heap memory

    if(char_ptr == NULL){
        msg_print_error(msg_error);
    }
    ...
    int_ptr = (int *)malloc_s(3*sizeof(int));
    ...
    *int_ptr = 31337; // put the value where int_ptr is pointing
    ...
    char_ptr = (char *)malloc_s(15*sizeof(char));
